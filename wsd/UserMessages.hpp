...
constexpr auto PAYLOAD_UNAVAILABLE_LIMIT_REACHED = "error: cmd=socket kind=hardlimitreached params=%d,%d";
constexpr auto PAYLOAD_INFO_LIMIT_REACHED = "info: cmd=socket kind=limitreached params=%d,%d";
