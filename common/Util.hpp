...
#define TEST(s_,c,n,e) \
  ...
  if (success)
    ...
    /// @param includingExtension When true, this method returns the full name, including extension.
    std::string getFilenameFromURL(const std::string& url, bool includingExtension = false);
