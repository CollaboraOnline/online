...
L.Control.TopToolbar = L.Control.extend({
	...
	getToolItems: function() {
		...
		return [
			...
			{type: 'menu', id: 'textalign', img: 'alignblock', hint: _UNO('.uno:TextAlign'), hidden: true, uno: '.uno:TextAlign',
				items: [
			...
			{type: 'menu',  id: 'linespacing',  img: 'linespacing', hint: _UNO('.uno:FormatSpacingMenu'), hidden: true, uno: '.uno:FormatSpacingMenu',
				items: [
			...
			{type: 'menu', id: 'menugraphic', img: 'insertgraphic', hint: _UNO('.uno:InsertGraphic', '', true), hidden: true, uno: '.uno:InsertGraphic',
				items: [
