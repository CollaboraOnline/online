...
var unoCommandsArray = {
	...
	AuditMenu:{spreadsheet:{menu:_('~Detective'),},},
	ShowPrecedents:{spreadsheet:{menu:_('Trace ~Precedents'),},},
	ShowDependents:{spreadsheet:{menu:_('~Trace Dependents'),},},
	ClearArrows:{spreadsheet:{menu:_('Remove ~All Traces'),},},
	ClearArrowPrecedents:{spreadsheet:{menu:_('~Remove Precedents'),},},
	ClearArrowDependents:{spreadsheet:{menu:_('Remove ~Dependents'),},},
	ShowPrecedents:{spreadsheet:{menu:_('Trace ~Precedents'),},},
	Protect:{spreadsheet:{menu:_('Protect ~Sheet...'),},},
	ToolProtectionDocument:{spreadsheet:{menu:_('Protect ~Spreadsheet Structure...'),},},
	...
	DataSubTotals:{spreadsheet:{menu:_('Sub~totals...'),},},
	DataForm:{spreadsheet:{menu:_('F~orm...'),},},
	DefineDBName:{spreadsheet:{menu:_('~Define Range...'),},},
	DataConsolidate:{spreadsheet:{menu:_('~Consolidate...'),},},
