...
ssize_t StreamSocket::readHeader(const char* clientName, std::istream& message,
...
bool StreamSocket::parseHeader(const char* clientName, size_t headerSize, size_t bufferSize,
