 ...
 */
/*
 * HTTP helper utilities for common server responses.
 *
 * HttpHelper namespace provides functions for sending error responses,
 * static files, and uncompressed file content over StreamSocket connections.
 */
