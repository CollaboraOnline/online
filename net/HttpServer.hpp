 ...
 */
/*
 * Server-side HTTP session for asynchronous file uploads.
 *
 * http::ServerSession - ProtocolHandlerInterface implementation that streams
 *                       file content to clients with support for HTTP Range
 *                       requests (partial content / resume downloads).
 */
