...
<html data-theme="%UI_THEME%">
  <head>
    ...
    <link rel="localizations" href="m4_ifelse(MOBILEAPP, [], [%SERVICE_ROOT%/browser/%VERSION%/])l10n/localizations.json" type="application/vnd.oftn.l10n+json"/>
    ...
    <script src="m4_ifelse(MOBILEAPP, [], [%SERVICE_ROOT%/browser/%VERSION%/])l10n.js" defer></script>
    <link
      rel="stylesheet"
