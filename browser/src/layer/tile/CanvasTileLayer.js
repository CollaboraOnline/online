...
L.CanvasTileLayer = L.Layer.extend({
	...
	_onMessage: function (textMsg, img) {
		...
		if (textMsg.startsWith('tile:') || textMsg.startsWith('delta:')) {
			...
			this._map._textInput.onAccessibilityFocusChanged(obj.content, parseInt(obj.position));
		}
			...
			this._map._textInput.setA11yFocusedParagraph(obj.content, parseInt(obj.start), parseInt(obj.end));
		}
