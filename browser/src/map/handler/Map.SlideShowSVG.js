/* -*- js-indent-level: 8 -*- */
/*
 * L.Map.SlideShowSVG is handling the slideShow action
 */
...
L.Map.SlideShowSVG = L.Handler.extend({
	...
	initialize: function (map) {
		this._map = map;
		window.app.console.log('L.Map.SlideShowSVG: Cypress in window: ' + ('Cypress' in window));
...
L.Map.addInitHook('addHandler', 'slideShowSVG', L.Map.SlideShowSVG);
