...
/* global app UNOKey UNOModifier isAnyVexDialogActive */
...
L.Map.Keyboard = L.Handler.extend({
	...
	_globalKeyEvent: function(ev) {
		...
		else if ((this._map._docLayer._docType === 'presentation' || this._map._docLayer._docType === 'drawing') && this._map._docLayer._preview.partsFocused === true && !isAnyVexDialogActive()) {
