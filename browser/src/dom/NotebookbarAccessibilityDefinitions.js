		...
		return {
			...
			'Home-tab-label': {
				...
				contentList: [
					...
					{ id: 'BackColorimg',					focusBack: true,	combination: 'HC',	de:	null	},
					{ id: 'FontColorimg',					focusBack: true,	combination: 'FC',	de: null	},
					{ id: 'LineSpacingimg',					focusBack: false,	combination: 'K',	de: null	},
					{ id: 'BackgroundColorimg',				focusBack: true,	combination: 'BC',	de: null	},
