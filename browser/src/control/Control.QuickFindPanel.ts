...
class QuickFindPanel extends SidebarBase {
	...
	createQuickFindArrows() {
		return {
			id: 'quickfind-controls',
			type: 'container',
			visible: false,
			children: [
				{
					id: 'quickfind-prev-button',
					type: 'pushbutton',
					text: '',
					image: 'lc_searchprev.svg',
				},
				{
					id: 'quickfind-next-button',
					type: 'pushbutton',
					text: '',
					image: 'lc_searchnext.svg',
				},
			],
		};
	}
	...
	onQuickFind(data: any) {
		...
		modifiedData.children.unshift(this.createQuickFindArrows());
