...
function _setBorders(left, right, bottom, top, horiz, vert, color) {
	map.sendUnoCommand(getBorderStyleUNOCommand(left, right, bottom, top, horiz, vert, color));
}

function getBorderStyleUNOCommand(left, right, bottom, top, horiz, vert, color) {
	const params = {
		OuterBorder: {
			type: '[]any',
			value: [
