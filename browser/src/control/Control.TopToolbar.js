...
class TopToolbar extends JSDialog.Toolbar {
	...
	getToolItems() {
		var items = [
			...
			{type: 'customtoolitem',  id: 'save', command: 'save', text: L.Control.Shortcuts.addShortcut(_UNO('.uno:Save'), L.Control.Shortcuts.shortcuts.SAVE), lockUno: '.uno:Save'},
			{type: 'customtoolitem',  id: 'print', command: 'print', text: L.Control.Shortcuts.addShortcut(_UNO('.uno:Print'), L.Control.Shortcuts.shortcuts.PRINT), mobile: false, tablet: false, lockUno: '.uno:Print'},
			...
			{type: 'toolitem',  id: 'undo', text: L.Control.Shortcuts.addShortcut(_UNO('.uno:Undo'), L.Control.Shortcuts.shortcuts.UNDO), command: '.uno:Undo', mobile: false},
			{type: 'toolitem',  id: 'redo', text: L.Control.Shortcuts.addShortcut(_UNO('.uno:Redo'), L.Control.Shortcuts.shortcuts.REDO), command: '.uno:Redo', mobile: false},
			...
			{type: 'toolitem',  id: 'bold', text: L.Control.Shortcuts.addShortcut(_UNO('.uno:Bold'), L.Control.Shortcuts.shortcuts.BOLD), command: '.uno:Bold'},
			{type: 'toolitem',  id: 'italic', text: L.Control.Shortcuts.addShortcut(_UNO('.uno:Italic'), L.Control.Shortcuts.shortcuts.ITALIC), command: '.uno:Italic'},
			{type: 'toolitem',  id: 'underline', text: L.Control.Shortcuts.addShortcut(_UNO('.uno:Underline'), L.Control.Shortcuts.shortcuts.UNDERLINE), command: '.uno:Underline'},
			{type: 'toolitem',  id: 'strikeout', text: L.Control.Shortcuts.addShortcut(_UNO('.uno:Strikeout'), L.Control.Shortcuts.shortcuts.STRIKETHROUGH), command: '.uno:Strikeout'},
			...
			{type: 'toolitem',  id: 'leftpara',  command: '.uno:LeftPara', text: L.Control.Shortcuts.addShortcut(_UNO('.uno:LeftPara', '', true), L.Control.Shortcuts.shortcuts.LEFT), visible: false},
			{type: 'toolitem',  id: 'centerpara',  command: '.uno:CenterPara', text: L.Control.Shortcuts.addShortcut(_UNO('.uno:CenterPara', '', true), L.Control.Shortcuts.shortcuts.CENTERED), visible: false},
			{type: 'toolitem',  id: 'rightpara',  command: '.uno:RightPara', text: L.Control.Shortcuts.addShortcut(_UNO('.uno:RightPara', '', true), L.Control.Shortcuts.shortcuts.RIGHT), visible: false},
			{type: 'toolitem',  id: 'justifypara',  command: '.uno:JustifyPara', text: L.Control.Shortcuts.addShortcut(_UNO('.uno:JustifyPara', '', true), L.Control.Shortcuts.shortcuts.JUSTIFIED), visible: false},
			...
			{type: 'menubutton', id: 'textalign', command: 'justifypara', noLabel: true, text: _UNO('.uno:TextAlign'), visible: false, lockUno: '.uno:TextAlign',
				menu: [
					{id: 'alignleft', text: L.Control.Shortcuts.addShortcut(_UNO('.uno:AlignLeft', 'spreadsheet', true), L.Control.Shortcuts.shortcuts.LEFT), icon: 'alignleft', uno: '.uno:AlignLeft'},
					{id: 'alignhorizontalcenter', text: L.Control.Shortcuts.addShortcut(_UNO('.uno:AlignHorizontalCenter', 'spreadsheet', true), L.Control.Shortcuts.shortcuts.CENTERED), icon: 'alignhorizontal', uno: '.uno:AlignHorizontalCenter'},
					{id: 'alignright', text: L.Control.Shortcuts.addShortcut(_UNO('.uno:AlignRight', 'spreadsheet', true), L.Control.Shortcuts.shortcuts.RIGHT), icon: 'alignright', uno: '.uno:AlignRight'},
					{id: 'alignblock', text: L.Control.Shortcuts.addShortcut(_UNO('.uno:AlignBlock', 'spreadsheet', true), L.Control.Shortcuts.shortcuts.JUSTIFIED), icon: 'alignblock', uno: '.uno:AlignBlock'},
					{type: 'separator'},
			...
			{type: 'customtoolitem',  id: 'insertannotation', text: L.Control.Shortcuts.addShortcut(_UNO('.uno:InsertAnnotation', '', true), L.Control.Shortcuts.shortcuts.COMMENT), visible: false, lockUno: '.uno:InsertAnnotation'},
