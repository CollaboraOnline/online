...
class TopToolbar extends JSDialog.Toolbar {
	...
	getToolItems() {
		...
		var fontGroup = [
			...
			{type: 'listbox', id: 'styles', text: _('Default Style'), desktop: true, mobile: false, tablet: false, accessibility: { focusBack: true, combination: 'DS' }},
			{type: 'listbox', id: 'fontnamecombobox', text: 'Carlito', command: '.uno:CharFontName', mobile: false, accessibility: { focusBack: true, combination: 'FN' }},
			{type: 'listbox', id: 'fontsizecombobox', text: '12 pt', command: '.uno:FontHeight', mobile: false, accessibility: { focusBack: true, combination: 'FS' }},
		];
		var formatGroup = [
