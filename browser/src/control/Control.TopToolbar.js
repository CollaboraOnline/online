...
class TopToolbar extends JSDialog.Toolbar {
	...
	getToolItems() {
		var items = [
			...
			{type: 'customtoolitem',  id: 'save', command: 'save', text: JSDialog.ShortcutsUtil.getShortcut(_UNO('.uno:Save'), JSDialog.ShortcutsUtil.SAVE), lockUno: '.uno:Save'},
			{type: 'customtoolitem',  id: 'print', command: 'print', text: JSDialog.ShortcutsUtil.getShortcut(_UNO('.uno:Print'), JSDialog.ShortcutsUtil.PRINT), mobile: false, tablet: false, lockUno: '.uno:Print'},
			...
			{type: 'toolitem',  id: 'undo', text: JSDialog.ShortcutsUtil.getShortcut(_UNO('.uno:Undo'), JSDialog.ShortcutsUtil.UNDO), command: '.uno:Undo', mobile: false},
			{type: 'toolitem',  id: 'redo', text: JSDialog.ShortcutsUtil.getShortcut(_UNO('.uno:Redo'), JSDialog.ShortcutsUtil.REDO), command: '.uno:Redo', mobile: false},
			...
			{type: 'toolitem',  id: 'bold', text: JSDialog.ShortcutsUtil.getShortcut(_UNO('.uno:Bold'), JSDialog.ShortcutsUtil.BOLD), command: '.uno:Bold'},
			{type: 'toolitem',  id: 'italic', text: JSDialog.ShortcutsUtil.getShortcut(_UNO('.uno:Italic'), JSDialog.ShortcutsUtil.ITALIC), command: '.uno:Italic'},
			{type: 'toolitem',  id: 'underline', text: JSDialog.ShortcutsUtil.getShortcut(_UNO('.uno:Underline'), JSDialog.ShortcutsUtil.UNDERLINE), command: '.uno:Underline'},
			{type: 'toolitem',  id: 'strikeout', text: JSDialog.ShortcutsUtil.getShortcut(_UNO('.uno:Strikeout'), JSDialog.ShortcutsUtil.STRIKETHROUGH), command: '.uno:Strikeout'},
			...
			{type: 'toolitem',  id: 'leftpara',  command: '.uno:LeftPara', text: JSDialog.ShortcutsUtil.getShortcut(_UNO('.uno:LeftPara', '', true), JSDialog.ShortcutsUtil.LEFT), visible: false},
			{type: 'toolitem',  id: 'centerpara',  command: '.uno:CenterPara', text: JSDialog.ShortcutsUtil.getShortcut(_UNO('.uno:CenterPara', '', true), JSDialog.ShortcutsUtil.CENTERED), visible: false},
			{type: 'toolitem',  id: 'rightpara',  command: '.uno:RightPara', text: JSDialog.ShortcutsUtil.getShortcut(_UNO('.uno:RightPara', '', true), JSDialog.ShortcutsUtil.RIGHT), visible: false},
			{type: 'toolitem',  id: 'justifypara',  command: '.uno:JustifyPara', text: JSDialog.ShortcutsUtil.getShortcut(_UNO('.uno:JustifyPara', '', true), JSDialog.ShortcutsUtil.JUSTIFIED), visible: false},
			...
			{type: 'menubutton', id: 'textalign', command: 'justifypara', noLabel: true, text: _UNO('.uno:TextAlign'), visible: false, lockUno: '.uno:TextAlign',
				menu: [
					{id: 'alignleft', text: JSDialog.ShortcutsUtil.getShortcut(_UNO('.uno:AlignLeft', 'spreadsheet', true), JSDialog.ShortcutsUtil.LEFT), icon: 'alignleft', uno: '.uno:AlignLeft'},
					{id: 'alignhorizontalcenter', text: JSDialog.ShortcutsUtil.getShortcut(_UNO('.uno:AlignHorizontalCenter', 'spreadsheet', true), JSDialog.ShortcutsUtil.CENTERED), icon: 'alignhorizontal', uno: '.uno:AlignHorizontalCenter'},
					{id: 'alignright', text: JSDialog.ShortcutsUtil.getShortcut(_UNO('.uno:AlignRight', 'spreadsheet', true), JSDialog.ShortcutsUtil.RIGHT), icon: 'alignright', uno: '.uno:AlignRight'},
					{id: 'alignblock', text: JSDialog.ShortcutsUtil.getShortcut(_UNO('.uno:AlignBlock', 'spreadsheet', true), JSDialog.ShortcutsUtil.JUSTIFIED), icon: 'alignblock', uno: '.uno:AlignBlock'},
					{type: 'separator'},
			...
			{type: 'customtoolitem',  id: 'insertannotation', text: JSDialog.ShortcutsUtil.getShortcut(_UNO('.uno:InsertAnnotation', '', true), JSDialog.ShortcutsUtil.COMMENT), visible: false, lockUno: '.uno:InsertAnnotation'},
