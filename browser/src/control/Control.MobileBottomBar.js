	...
	getToolItems: function(docType) {
		if (docType == 'text') {
			...
			return [
				...
				{type: 'button',  id: 'bold',  img: 'bold', hint: _UNO('.uno:Bold'), uno: '.uno:Bold', context: ['default', 'Cell', 'Text', 'DrawText']},
				{type: 'button',  id: 'italic', img: 'italic', hint: _UNO('.uno:Italic'), uno: '.uno:Italic', context: ['default', 'Cell', 'Text', 'DrawText']},
				{type: 'button',  id: 'underline',  img: 'underline', hint: _UNO('.uno:Underline'), uno: '.uno:Underline', context: ['default', 'Cell', 'Text', 'DrawText']},
				{type: 'break', context: ['default', 'Cell', 'Text', 'DrawText']},
				{type: 'button',  id: 'fontcolor', img: 'textcolor', hint: _UNO('.uno:FontColor'), freemiumUno: '.uno:FontColor', context: ['default', 'Cell', 'Text', 'DrawText']},
				{type: 'button',  id: 'backcolor', img: 'backcolor', hint: _UNO('.uno:BackgroundColor'), freemiumUno: '.uno:BackgroundColor', context: ['default', 'Cell', 'Text', 'DrawText']},
				{type: 'drop',  id: 'setborderstyle',  img: 'setborderstyle', hint: _('Borders'), hidden: true, html: window.getBorderStyleMenuHtml(), context: ['default', 'Cell', 'Text']},
				{type: 'break', context: ['default', 'Cell', 'Text', 'DrawText']},
				{type: 'menu', id: 'textalign', img: 'alignblock', hint: _UNO('.uno:TextAlign'), freemiumUno: '.uno:TextAlign', context: ['default', 'Cell', 'Text', 'DrawText'],
					items: [
				...
				{type: 'button',  id: 'wraptext',  img: 'wraptext', hint: _UNO('.uno:WrapText', 'spreadsheet', true), uno: '.uno:WrapText', disabled: true, context: ['default', 'Cell', 'Text', 'DrawText']},
				{type: 'break', context: ['default', 'Cell', 'Text', 'DrawText']},
				{type: 'menu', id: 'numberformatstandard', img: 'numberformatstandard', hint: _UNO('.uno:NumberFormatStandard'), freemiumUno: '.uno:NumberFormatStandard', context: ['default', 'Cell', 'Text'],
					items: [
				...
				{type: 'button',  id: 'numberformatincdecimals',  img: 'numberformatincdecimals', hint: _UNO('.uno:NumberFormatIncDecimals', 'spreadsheet', true), uno: '.uno:NumberFormatIncDecimals', disabled: true, context: ['default', 'Cell', 'Text']},
				{type: 'button',  id: 'numberformatdecdecimals',  img: 'numberformatdecdecimals', hint: _UNO('.uno:NumberFormatDecDecimals', 'spreadsheet', true), uno: '.uno:NumberFormatDecDecimals', disabled: true, context: ['default', 'Cell', 'Text']},
				{type: 'break', context: ['default', 'Cell', 'Text']},
				{type: 'menu', id: 'insertrowsbefore', img: 'insertrowsbefore', hint: _UNO('.uno:InsertRowsBefore'), freemiumUno: '.uno:InsertRowsBefore', context: ['default', 'Cell', 'Text'],
					items: [
				...
				{type: 'menu', id: 'insertcolumnsbefore', img: 'insertcolumnsbefore', hint: _UNO('.uno:InsertColumnsBefore'), freemiumUno: '.uno:InsertColumnsBefore', context: ['default', 'Cell', 'Text'],
					items: [
						...
						{type: 'break'},
						{id: 'freezepanescolumn', hint: _UNO('.uno:FreezePanesColumn', 'spreadsheet', true), img: 'freezepanescolumn', uno: '.uno:FreezePanesColumn', context: ['default', 'Cell', 'Text']},
					]},
				{type: 'button',  id: 'togglemergecells',  img: 'togglemergecells', hint: _UNO('.uno:ToggleMergeCells', 'spreadsheet', true), uno: '.uno:ToggleMergeCells', disabled: true, context: ['default', 'Cell', 'Text']},
				{type: 'break', context: ['default', 'Cell', 'Text']},
				{type: 'drop', id: 'conditionalformaticonset',  img: 'conditionalformatdialog', hint: _UNO('.uno:ConditionalFormatMenu', 'spreadsheet', true), html: window.getConditionalFormatMenuHtml(), uno: '.uno:ConditionalFormatMenu', context: ['default', 'Cell', 'Text']},
				{type: 'button',  id: 'sortascending',  img: 'sortascending', hint: _UNO('.uno:SortAscending', 'spreadsheet', true), uno: '.uno:SortAscending', context: ['default', 'Cell', 'Text']},
				{type: 'button',  id: 'sortdescending',  img: 'sortdescending', hint: _UNO('.uno:SortDescending', 'spreadsheet', true), uno: '.uno:SortDescending', context: ['default', 'Cell', 'Text']},
				// context: ['Draw', 'DrawLine', '3DObject', 'MultiObject', 'Graphic', 'DrawFontwork']
				{type: 'menu', id: 'aligncenter', img: 'aligncenter', hint: _UNO('.uno:AlignCenter'), freemiumUno: '.uno:AlignCenter', context: ['Draw', 'DrawLine', '3DObject', 'MultiObject', 'Graphic', 'DrawFontwork'],
					items: [
						{id: 'objectalignleft', hint: _UNO('.uno:ObjectAlignLeft', 'spreadsheet', true), img: 'objectalignleft', uno: '.uno:ObjectAlignLeft'},
						{id: 'aligncenter', hint: _UNO('.uno:AlignCenter', 'spreadsheet', true), img: 'aligncenter', uno: '.uno:AlignCenter'},
						{id: 'objectalignright', hint: _UNO('.uno:ObjectAlignRight', 'spreadsheet', true), img: 'objectalignright', uno: '.uno:ObjectAlignRight'},
						{type: 'break'},
						{id: 'alignup', hint: _UNO('.uno:AlignUp', 'spreadsheet', true), img: 'alignup', uno: '.uno:AlignUp'},
						{id: 'alignmiddle', hint: _UNO('.uno:AlignMiddle', 'spreadsheet', true), img: 'alignmiddle', uno: '.uno:AlignMiddle'},
						{id: 'aligndown', hint: _UNO('.uno:AlignDown', 'spreadsheet', true), img: 'aligndown', uno: '.uno:AlignDown'},
					]},
				{type: 'menu', id: 'arrangemenu', img: 'arrangemenu', hint: _UNO('.uno:ArrangeMenu'), freemiumUno: '.uno:ArrangeMenu', context: ['Draw', 'DrawLine', '3DObject', 'MultiObject', 'Graphic', 'DrawFontwork'],
					items: [
						{id: 'bringtofront', hint: _UNO('.uno:BringToFront', 'spreadsheet', true), img: 'bringtofront', uno: '.uno:BringToFront'},
						{type: 'break'},
						{id: 'objectforwardone', hint: _UNO('.uno:ObjectForwardOne', 'spreadsheet', true), img: 'objectforwardone', uno: '.uno:ObjectForwardOne'},
						{id: 'objectbackone', hint: _UNO('.uno:ObjectBackOne', 'spreadsheet', true), img: 'objectbackone', uno: '.uno:ObjectBackOne'},
						{type: 'break'},
						{id: 'sendtoback', hint: _UNO('.uno:SendToBack', 'spreadsheet', true), img: 'sendtoback', uno: '.uno:SendToBack'},
					]},
				{type: 'button',  id: 'flipvertical',  img: 'flipvertical', hint: _UNO('.uno:FlipVertical', 'spreadsheet', true), uno: '.uno:FlipVertical', context: ['Draw', 'DrawLine', '3DObject', 'MultiObject', 'Graphic', 'DrawFontwork']},
				{type: 'button',  id: 'fliphorizontal',  img: 'fliphorizontal', hint: _UNO('.uno:FlipHorizontal', 'spreadsheet', true), uno: '.uno:FlipHorizontal', context: ['Draw', 'DrawLine', '3DObject', 'MultiObject', 'Graphic', 'DrawFontwork']},
			];
		} else if ((docType == 'presentation') || (docType == 'drawing')) {
			return [
				{type: 'button',  id: 'showsearchbar',  img: 'search', hint: _('Show the search bar')},
				{type: 'break', context: ['default', 'Text', 'TextObject', 'DrawText', 'Table', 'Draw', 'DrawLine', '3DObject', 'MultiObject', 'Graphic', 'DrawFontwork']},
				{type: 'button',  id: 'bold',  img: 'bold', hint: _UNO('.uno:Bold'), uno: '.uno:Bold', context: ['default', 'Text', 'TextObject', 'DrawText', 'Table']},
				{type: 'button',  id: 'italic', img: 'italic', hint: _UNO('.uno:Italic'), uno: 'Italic', context: ['default', 'Text', 'TextObject', 'DrawText', 'Table']},
				{type: 'button',  id: 'underline',  img: 'underline', hint: _UNO('.uno:Underline'), uno: '.uno:Underline', context: ['default', 'Text', 'TextObject', 'DrawText', 'Table']},
				{type: 'break', context: ['default', 'Text', 'TextObject', 'DrawText', 'Table']},
				{type: 'button',  id: 'fontcolor', img: 'textcolor', hint: _UNO('.uno:FontColor'), freemiumUno: '.uno:FontColor', context: ['default', 'Text', 'TextObject', 'DrawText', 'Table']},
				{type: 'button',  id: 'backcolor', img: 'backcolor', hint: _UNO('.uno:BackgroundColor'), freemiumUno: '.uno:BackgroundColor', context: ['default', 'Text', 'TextObject', 'DrawText', 'Table']},
				{type: 'break', context: ['default', 'Text', 'TextObject', 'DrawText', 'Table']},
				{type: 'menu', id: 'textalign', img: 'alignblock', hint: _UNO('.uno:TextAlign'), freemiumUno: '.uno:TextAlign', context: ['default', 'Text', 'TextObject', 'DrawText', 'Table'],
					items: [
				...
				{type: 'button',  id: 'defaultbullet',  img: 'bullet', hint: _UNO('.uno:DefaultBullet', '', true), uno: '.uno:DefaultBullet', disabled: true, context: ['default', 'Text', 'TextObject', 'DrawText', 'Table']},
				// context: ['Table']
				{type: 'break', context: ['Table']},
				{type: 'menu', id: 'insertrowsbefore', img: 'insertrowsbefore', hint: _UNO('.uno:InsertRowsBefore'), freemiumUno: '.uno:InsertRowsBefore', context: ['Table'],
					items: [
				...
				// context: ['Draw', 'DrawLine', '3DObject', 'MultiObject', 'Graphic', 'DrawFontwork']
				{type: 'break', context: ['TextObject']},
				{type: 'menu', id: 'aligncenter', img: 'aligncenter', hint: _UNO('.uno:AlignCenter'), freemiumUno: '.uno:AlignCenter', context: ['default', 'Text', 'TextObject', 'Draw', 'DrawLine', '3DObject', 'MultiObject', 'Graphic', 'DrawFontwork'],
					items: [
				...
				{type: 'menu', id: 'arrangemenu', img: 'arrangemenu', hint: _UNO('.uno:ArrangeMenu'), freemiumUno: '.uno:ArrangeMenu', context: ['default', 'Text', 'TextObject', 'Draw', 'DrawLine', '3DObject', 'MultiObject', 'Graphic', 'DrawFontwork'],
					items: [
				...
				{type: 'button',  id: 'flipvertical',  img: 'flipvertical', hint: _UNO('.uno:FlipVertical', 'presentation', true), uno: '.uno:FlipVertical', context: ['Draw', 'DrawLine', '3DObject', 'MultiObject', 'Graphic', 'DrawFontwork']},
				{type: 'button',  id: 'fliphorizontal',  img: 'fliphorizontal', hint: _UNO('.uno:FlipHorizontal', 'presentation', true), uno: '.uno:FlipHorizontal', context: ['Draw', 'DrawLine', '3DObject', 'MultiObject', 'Graphic', 'DrawFontwork']},
				// context: none
				{type: 'break'},
				{type: 'button',  id: 'insertpage',  img: 'insertpage', hint: _UNO('.uno:InsertPage'), uno: '.uno:InsertPage'},
				{type: 'button',  id: 'duplicatepage',  img: 'duplicatepage', hint: _UNO('.uno:DuplicatePage'), uno: '.uno:DuplicatePage'},
				{type: 'break'},
				...
				{type: 'button',  id: 'insertannotation', img: 'annotation', hint: _UNO('.uno:InsertAnnotation', '', true), freemiumUno: '.uno:InsertAnnotation'},
			];
		}
	},
