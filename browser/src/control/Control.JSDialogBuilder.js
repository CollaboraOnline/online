...
L.Control.JSDialogBuilder = L.Control.extend({
	...
	_createIconURL: function(name) {
		...
		var iconURLAliases = {
			...
			'basicshapes.ellipse': 'insertshape',
			'setparagraphlanguagemenu': 'spelldialog',
			'spellingandgrammardialog': 'spelldialog',
			'spellonline': 'spelldialog',
			'lc_styleapply3fstyle3astring3ddefault26familyname3astring3dcellstyles.svg': 'fontcolor',
			'fontworkshapetype.fontwork-arch-up-pour': 'basicshapes.block-arc',
			'fontworkgalleryfloater': 'fontworkpropertypanel',
			'flowchartshapes.flowchart-internal-storage': 'flowchartshapes',
			...
			'outlineup': 'moveup',
			'calloutshapes.line-callout-2': 'inserttopicfield',
