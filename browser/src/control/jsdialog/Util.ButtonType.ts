...
function getDialogButtons() {
	return [
		...
		'.uno:DocumentRepair', // Repair button sends this command yet doesn't get dialog attribute
		'.uno:EditRegion',
		'.uno:FontDialog',
		...
		'.uno:ParagraphDialog',
		'.uno:Print',
		'.uno:RenameMasterPage',
		'.uno:ReportIssue',
		'.uno:RunMacro',
		'.uno:SearchDialog', // The one in Impress and Calc, which is a dialog
