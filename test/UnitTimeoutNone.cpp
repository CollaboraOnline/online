...
class UnitTimeoutNone : public UnitWSD
{
...
UnitBase::TestResult UnitTimeoutNone::testHttpNoTimeout()
{
...
UnitBase::TestResult UnitTimeoutNone::testWSPingNoTimeout()
{
    setTestname(__func__);
    TST_LOG("Starting Test: " << testname);
...
UnitBase::TestResult UnitTimeoutNone::testWSDChatPingPong()
{
    setTestname(__func__);
    TST_LOG("Starting Test: " << testname);
