...
describe(['tagscreenshot'], 'Help dialog screenshot updation', function() {
	...
	it('Document repair', function() {
		...
		cy.cGet('#menu-editmenu').click()
			.cGet('#menu-repair').click();

		cy.cGet('.leaflet-popup-content-wrapper')
			.should('exist');
	...
	it.skip('Comment', function() {
		...
		cy.cGet('#new-mobile-comment-input-area').type('comment added');
		cy.cGet('.vex-dialog-buttons .button-primary').click();
		cy.cGet('.cool-annotation-collapsed').click();
	...
	it('word count', function() {
		...
		cy.cGet('body').contains('#menu-tools li a', 'Word Count...')
			.click();
	...
	it('insert special', function() {
		...
		cy.cGet('#tb_editbar_item_insertsymbol')
			.click();

		cy.cGet('.lokdialog_canvas')
			.should('exist');

		helper.waitUntilIdle('.lokdialog_container');

		cy.cGet('.lokdialog_container')
	...
	it('manage changes', function() {
		cy.cGet('#menu-editmenu')
			.click()
			.cGet('#menu-changesmenu')
			.click()
			.contains('Record')
			.click();
