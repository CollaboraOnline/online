...
describe(['tagmobile'], 'Annotation tests.', function() {
	...
	it('Modifying comment.', function() {
		...
		cy.cGet('#new-mobile-comment-input-area').type('{home}modified ');
	...
	it('Reply to comment.', function() {
		...
		cy.cGet('#new-mobile-comment-input-area').should('have.text', '');

		cy.cGet('#new-mobile-comment-input-area').type('reply');
